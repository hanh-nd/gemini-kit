...
- You MUST save your final report to: `.geminit-kit/tmp/scout/scout-[timestamp]-{{args|slugify}}.md`
- Use `mkdir -p .geminit-kit/tmp/scout` before saving to ensure the path exists.
...
`/plan @.geminit-kit/tmp/scout/scout-[timestamp]-{{args|slugify}}.md`
```
