...
- **review-pr**: Added Jira ticket alignment check. The command now automatically detects Jira ticket IDs in command arguments or PR title/description, fetches ticket details, and verifies if the implementation aligns with requirements.
