...
1. `skills/code-review/references/01-macro-triaging.md` (Intent & Blast Radius rules)
2. `skills/code-review/references/02-micro-execution.md` (Data tracing & Actionability rules)
3. `skills/code-review/references/03-baseline-security.md` (Vulnerability rules)
4. `skills/code-review/references/04-baseline-performance.md` (Performance rules)
5. `skills/code-review/references/05-test-parity.md` (Test Parity rules)
